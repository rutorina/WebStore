...
`;
    ...
    createClassDiagram() {
        ...
        content += `        <mxCell id="${userClass}" value="User" style="swimlane;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="1">
          <mxGeometry x="50" y="50" width="220" height="300" as="geometry"/>
        </mxCell>
`;
...
`;
        ...
        content += `        <mxCell id="${this.generateId()}" value="- password: string" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;" vertex="1" parent="${userClass}">
          <mxGeometry y="104" width="220" height="26" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="- isAdmin: boolean" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;" vertex="1" parent="${userClass}">
          <mxGeometry y="130" width="220" height="26" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="- phone: string" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;" vertex="1" parent="${userClass}">
...
`;
        ...
        const saveToCart = this.generateId();
        content += `        <mxCell id="${saveToCart}" value="Збереження\\nв кошик" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${systemLane}">
          <mxGeometry x="620" y="50" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const displayCart = this.generateId();
        content += `        <mxCell id="${displayCart}" value="Відображення\\nкошика" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${systemLane}">
          <mxGeometry x="740" y="50" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const validateOrder = this.generateId();
        content += `        <mxCell id="${validateOrder}" value="Валідація\\nзамовлення" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${systemLane}">
          <mxGeometry x="860" y="50" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const createOrder = this.generateId();
        content += `        <mxCell id="${createOrder}" value="Створення\\nзамовлення" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${systemLane}">
          <mxGeometry x="980" y="50" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        // Decision gateway
        const paymentGateway = this.generateId();
        content += `        <mxCell id="${paymentGateway}" value="Оплата\\nуспішна?" style="rhombus;whiteSpace=wrap;html=1;fillColor=#ffe6cc;strokeColor=#d79b00;" vertex="1" parent="${systemLane}">
          <mxGeometry x="1050" y="35" width="80" height="80" as="geometry"/>
        </mxCell>
`;

        // Payment system activities
        const processPayment = this.generateId();
        content += `        <mxCell id="${processPayment}" value="Обробка\\nплатежу" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${paymentLane}">
          <mxGeometry x="980" y="35" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const paymentConfirmation = this.generateId();
        content += `        <mxCell id="${paymentConfirmation}" value="Підтвердження\\nоплати" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${paymentLane}">
...
`;
        ...
        const checkStock = this.generateId();
        content += `        <mxCell id="${checkStock}" value="Перевірка\\nналяності" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${warehouseLane}">
          <mxGeometry x="860" y="35" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const prepareOrder = this.generateId();
        content += `        <mxCell id="${prepareOrder}" value="Підготовка\\nзамовлення" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${warehouseLane}">
          <mxGeometry x="980" y="35" width="80" height="50" as="geometry"/>
        </mxCell>
`;

        const shipOrder = this.generateId();
        content += `        <mxCell id="${shipOrder}" value="Відправка\\nзамовлення" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;" vertex="1" parent="${warehouseLane}">
          <mxGeometry x="1100" y="35" width="80" height="50" as="geometry"/>
        </mxCell>
`;
        ...
        // End event
        const endEvent = this.generateId();
        content += `        <mxCell id="${endEvent}" value="Замовлення\\nвиконано" style="ellipse;whiteSpace=wrap;html=1;fillColor=#f8cecc;strokeColor=#b85450;aspect=fixed;" vertex="1" parent="1">
          <mxGeometry x="1220" y="135" width="50" height="50" as="geometry"/>
        </mxCell>
`;

        // Error end event
        const errorEvent = this.generateId();
        content += `        <mxCell id="${errorEvent}" value="Помилка\\nоплати" style="ellipse;whiteSpace=wrap;html=1;fillColor=#ffcccc;strokeColor=#ff0000;strokeWidth=3;aspect=fixed;" vertex="1" parent="1">
          <mxGeometry x="1170" y="255" width="50" height="50" as="geometry"/>
        </mxCell>
`;

        // Message flows
        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${browseCatalog}" target="${displayCatalog}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${searchFilter}" target="${processSearch}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${selectProduct}" target="${showProduct}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${viewDetails}" target="${showDetails}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${addToCart}" target="${saveToCart}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${reviewCart}" target="${displayCart}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${fillOrderInfo}" target="${validateOrder}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${confirmOrder}" target="${createOrder}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${createOrder}" target="${processPayment}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${validateOrder}" target="${checkStock}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${processPayment}" target="${paymentConfirmation}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${paymentConfirmation}" target="${paymentGateway}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${checkStock}" target="${prepareOrder}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${prepareOrder}" target="${shipOrder}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;dashed=1;strokeColor=#666666;" edge="1" parent="1" source="${shipOrder}" target="${receiveGoods}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        // Sequence flows within customer lane
        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${startEvent}" target="${browseCatalog}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${browseCatalog}" target="${searchFilter}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${searchFilter}" target="${selectProduct}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;
...
`;
        ...
        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${viewDetails}" target="${addToCart}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${addToCart}" target="${reviewCart}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${reviewCart}" target="${fillOrderInfo}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${fillOrderInfo}" target="${confirmOrder}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${confirmOrder}" target="${receiveGoods}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        // Gateway flows
        content += `        <mxCell id="${this.generateId()}" value="Так" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${paymentGateway}" target="${endEvent}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="Ні" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${paymentGateway}" target="${errorEvent}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;

        content += `        <mxCell id="${this.generateId()}" value="" style="endArrow=classic;html=1;rounded=0;" edge="1" parent="1" source="${receiveGoods}" target="${endEvent}">
          <mxGeometry width="50" height="50" relative="1" as="geometry"/>
        </mxCell>
`;
