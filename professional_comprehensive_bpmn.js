...
// BPMN 2.0 Professional Diagram Generator
// Follows OMG BPMN 2.0 specification with all proper markings
// Generates comprehensive e-commerce process flow
...
function createFlow(sourceId, targetId, label = '', flowType = 'SEQUENCE') {
    ...
    return createCell(id, label, style, {
        sourceX: 0, sourceY: 0, targetX: 0, targetY: 0
    }, '1') + `\n        <mxCell id="${id}" source="${sourceId}" target="${targetId}"/>`;
}
...
<mxfile host="app.diagrams.net" modified="2024-12-19T10:00:00.000Z" agent="5.0" etag="comprehensive-bpmn" version="24.7.17">
  <diagram name="Professional BPMN 2.0 - TechnoSvit E-commerce" id="comprehensive-bpmn-diagram">
...
// Generate and save the comprehensive BPMN diagram
const bpmnXML = generateComprehensiveBPMN();

fs.writeFileSync('Professional_Comprehensive_BPMN_TechnoSvit.drawio', bpmnXML, 'utf8');

console.log('✅ Comprehensive Professional BPMN 2.0 diagram generated successfully!');
console.log('📁 File: Professional_Comprehensive_BPMN_TechnoSvit.drawio');
...
console.log('   • Subprocess for error handling');
